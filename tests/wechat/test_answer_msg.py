...
class AnswerMsgTestCase (TestCase):
    ...
    def test_cryptor(self):
        ...
        data = '''<xml>
                ...
                <Encrypt><![CDATA[]]></Encrypt></xml>'''
        ...
        invalid_param = {'signature': '4dbdbe7c66c7d80b6b2b59e138a58484f915256b', 'timestamp': '1409735669',
                         ...
                         'nonce': '1320562132', 'encrypt_type': 'aes'}
